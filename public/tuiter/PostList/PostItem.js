...
const PostItem = (post) =>{
    ...
    <div class="list-group-item d-flex border-secondary" style="border-width: 0 0 1px 0">
        ...
        <div class="col-11 mt-2 ms-2" style="padding-left: 10px; max-width: 514px">
            <span class="wd-font-size-15px wd-display-inline">${post.userName}</span>
...
<!--            <div class="wd-clear-float"></div>-->
            <div class="wd-font-size-15px wd-content-max-width-506px wd-margin-top-5px wd-margin-bottom-10px" 
            ...
            <div class="border mt-2 wd-content-max-width-506px border-secondary" style="border-radius: 15px">
                ${post.title && post.content && post.link ? `
                    ...
                    ${post.link ? `<a href="#" class="fa-solid fa-link text-muted text-decoration-none"></a><a href="#" class="text-muted text-decoration-none">${post.link}</a>` : ''}                  
                    </div>
                    ` : `
